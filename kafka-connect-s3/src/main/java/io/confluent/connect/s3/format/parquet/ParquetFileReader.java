...
public class ParquetFileReader
    implements io.confluent.connect.storage.format.SchemaFileReader<S3SinkConnectorConfig, Path> {
  ...
  @Override
  public Schema getSchema(S3SinkConnectorConfig conf, Path path) {
